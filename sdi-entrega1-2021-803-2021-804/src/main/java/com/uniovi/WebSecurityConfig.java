...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.csrf().disable().authorizeRequests()
				...
				.antMatchers("/").hasAnyAuthority("ROLE_USUARIO","ROLE_ADMIN")
				.antMatchers("/home").hasAnyAuthority("ROLE_USUARIO","ROLE_ADMIN")
				.antMatchers("/oferta/add").hasAuthority("ROLE_USUARIO")
				.antMatchers("/oferta/list").hasAuthority("ROLE_USUARIO")
