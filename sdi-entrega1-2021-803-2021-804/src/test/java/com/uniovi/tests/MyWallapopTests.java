...
public class MyWallapopTests {
	...
	public void initdb() {
		...
		Oferta u1a = new Oferta("Patinete", "Patinete de segunda mano marca 'Joi'. Una semana de uso",
				Date.valueOf(LocalDate.now()), 20, user1);
		Oferta u1b = new Oferta("Cesta picnic", "Ideal mochila para picnic. Dimensiones: 30x25", Date.valueOf(LocalDate.now()),
				12, user1);
		Oferta u1c = new Oferta("Abrigo", "Ideal para el invierno, impermeable y de color rojo", Date.valueOf(LocalDate.now()),
				25, user1);
		...
		Oferta u3c = new Oferta("Maletas", "Maletas grandes para meter mucho equipaje", Date.valueOf(LocalDate.now()), 30,
				user3);
		...
		Oferta u4c = new Oferta("Maquina de escribir", "Maquina recien comprada, 1 semana de uso", Date.valueOf(LocalDate.now()),
				65, user4);
		Oferta u5a = new Oferta("Pantalones de chandal", "Patalones de chandal negro de adidas", Date.valueOf(LocalDate.now()),
				20, user5);
		Oferta u5b = new Oferta("Calculadora", "Calculadora cientifica", Date.valueOf(LocalDate.now()), 34, user5);
		Oferta u5c = new Oferta("Bicicleta", "Bicicleta de montaña, de color rojo", Date.valueOf(LocalDate.now()), 102, user5);
