...
public class PO_OfertaUserList extends PO_NavView {
	...
	static public void comprobarAllOfertas(WebDriver driver, User usuario, List<Oferta> ofertas, List<WebElement> elementos) {
		int posicion = 0;
	...
	static public void comprobarAllOfertasPaginaPorPagina(WebDriver driver, User usuario, List<Oferta> ofertas, List<WebElement> elementos) {
		int posicion = 0;
		elementos = PO_View.checkElement(driver, "free", "//a[contains(@class, 'page-link')]");
		//Vamos pagina por pagina (elementos)
		while(true) {
